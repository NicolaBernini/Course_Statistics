...
- Prediction : $P(\{S_{_{\tau}}\}_{\tau \in [t, t_{1}]} | \{Z_{\tau}\}_{\tau \in [t_{0},t]})$ which is focused on estimating the future states in the $[t, t_{1}]$ timeframe from the available knowledge 
